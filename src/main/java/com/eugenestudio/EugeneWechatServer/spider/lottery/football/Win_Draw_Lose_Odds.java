package com.eugenestudio.EugeneWechatServer.spider.lottery.football;

import com.eugenestudio.EugeneWechatServer.spider.constant.Constant;
import com.eugenestudio.EugeneWechatServer.spider.dao.DatabaseConnection;
...
public class Win_Draw_Lose_Odds {
    ...
    private void saveInformationsToDatabase() {
        ...
        for (long i = Long.parseLong(Constant.startPageNumber); i <= Long.parseLong(Constant.endPageNumber); i++) {
            ...
            System.out.println("当前url为" + url + "第" + count + "条数据成功插入数据库");
            count++;
        }
